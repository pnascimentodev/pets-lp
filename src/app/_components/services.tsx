...
import { ChevronLeft, ChevronRight, Scissors, Syringe, CarTaxiFront, Ambulance, Hotel, Clock } from 'lucide-react'
...
const services = [
  ...
  {
    title: "Socorro Pet",
    description: "Serviço de transporte de emergência, para levar os pets em clínicas veterinárias ou hospitais veterinários. Ideal para bichinhos que estão em situação de urgência e precisam ser atendidos rapidamente.",
    duration: "30min",
    price: "$100",
    icon: <Ambulance />,
    linkText: 'Olá, vi no site sobre Socorro Pet e gostaria de mais informações.'
  },
  {
    title: "Táxi Pet",
